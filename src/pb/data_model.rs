...
pub struct Arrow {
    // message fields
    from_x: ::std::option::Option<u32>,
    from_y: ::std::option::Option<u32>,
    to_x: ::std::option::Option<u32>,
    to_y: ::std::option::Option<u32>,
    // special fields
    unknown_fields: ::protobuf::UnknownFields,
    cached_size: ::std::cell::Cell<u32>,
}
...
impl Arrow {
    ...
    pub fn default_instance() -> &'static Arrow {
        ...
        unsafe {
            instance.get(|| {
                Arrow {
                    from_x: ::std::option::Option::None,
                    from_y: ::std::option::Option::None,
                    to_x: ::std::option::Option::None,
                    to_y: ::std::option::Option::None,
                    unknown_fields: ::protobuf::UnknownFields::new(),
                    cached_size: ::std::cell::Cell::new(0),
                }
            })
    ...
    pub fn clear_from_x(&mut self) {
        self.from_x = ::std::option::Option::None;
    }

    pub fn has_from_x(&self) -> bool {
        self.from_x.is_some()
    }

    // Param is passed by value, moved
    pub fn set_from_x(&mut self, v: u32) {
        self.from_x = ::std::option::Option::Some(v);
    }

    pub fn get_from_x(&self) -> u32 {
        self.from_x.unwrap_or(0)
    }

    // required uint32 from_y = 2;

    pub fn clear_from_y(&mut self) {
        self.from_y = ::std::option::Option::None;
    }

    pub fn has_from_y(&self) -> bool {
        self.from_y.is_some()
    }

    // Param is passed by value, moved
    pub fn set_from_y(&mut self, v: u32) {
        self.from_y = ::std::option::Option::Some(v);
    }

    pub fn get_from_y(&self) -> u32 {
        self.from_y.unwrap_or(0)
    }

    // required uint32 to_x = 3;

    pub fn clear_to_x(&mut self) {
        self.to_x = ::std::option::Option::None;
    }

    pub fn has_to_x(&self) -> bool {
        self.to_x.is_some()
    }

    // Param is passed by value, moved
    pub fn set_to_x(&mut self, v: u32) {
        self.to_x = ::std::option::Option::Some(v);
    }

    pub fn get_to_x(&self) -> u32 {
        self.to_x.unwrap_or(0)
    }

    // required uint32 to_y = 4;

    pub fn clear_to_y(&mut self) {
        self.to_y = ::std::option::Option::None;
    }

    pub fn has_to_y(&self) -> bool {
        self.to_y.is_some()
    }

    // Param is passed by value, moved
    pub fn set_to_y(&mut self, v: u32) {
        self.to_y = ::std::option::Option::Some(v);
    }

    pub fn get_to_y(&self) -> u32 {
        self.to_y.unwrap_or(0)
    }
}

impl ::protobuf::Message for Arrow {
    fn is_initialized(&self) -> bool {
        if self.from_x.is_none() {
            return false;
        };
        if self.from_y.is_none() {
            return false;
        };
        if self.to_x.is_none() {
            return false;
        };
        if self.to_y.is_none() {
            return false;
        };
        true
    }
        ...
        while !try!(is.eof()) {
            ...
            match field_number {
                1 => {
                    ...
                    let tmp = try!(is.read_uint32());
                    self.from_x = ::std::option::Option::Some(tmp);
                },
                2 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = try!(is.read_uint32());
                    self.from_y = ::std::option::Option::Some(tmp);
                },
                3 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = try!(is.read_uint32());
                    self.to_x = ::std::option::Option::Some(tmp);
                },
                4 => {
                    if wire_type != ::protobuf::wire_format::WireTypeVarint {
                        return ::std::result::Result::Err(::protobuf::rt::unexpected_wire_type(wire_type));
                    ...
                    let tmp = try!(is.read_uint32());
                    self.to_y = ::std::option::Option::Some(tmp);
                },
                _ => {
                    try!(::protobuf::rt::read_unknown_or_skip_group(field_number, wire_type, is, self.mut_unknown_fields()));
                },
    ...
    fn compute_size(&self) -> u32 {
        let mut my_size = 0;
        for value in &self.from_x {
            my_size += ::protobuf::rt::value_size(1, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.from_y {
            my_size += ::protobuf::rt::value_size(2, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.to_x {
            my_size += ::protobuf::rt::value_size(3, *value, ::protobuf::wire_format::WireTypeVarint);
        };
        for value in &self.to_y {
    ...
    fn write_to_with_cached_sizes(&self, os: &mut ::protobuf::CodedOutputStream) -> ::protobuf::ProtobufResult<()> {
        if let Some(v) = self.from_x {
            try!(os.write_uint32(1, v));
        };
        if let Some(v) = self.from_y {
            try!(os.write_uint32(2, v));
        };
        if let Some(v) = self.to_x {
            try!(os.write_uint32(3, v));
        };
        if let Some(v) = self.to_y {
...
static file_descriptor_proto_data: &'static [u8] = &[
    ...
    ,
    ...
    0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x00, 0x01, 0x12, 0x03, 0x05, 0x12, 0x15, 0x0a, 0x0c, 0x0a,
    0x05, 0x04, 0x00, 0x02, 0x00, 0x03, 0x12, 0x03, 0x05, 0x18, 0x19, 0x0a, 0x0b, 0x0a, 0x04, 0x04,
    0x00, 0x02, 0x01, 0x12, 0x03, 0x06, 0x02, 0x1c, 0x0a, 0x0c, 0x0a, 0x05, 0x04, 0x00, 0x02, 0x01,
    ...
    ,
    ...
    ,
];
